package com.bank.bian.advisorworkbench.model;
...
/**
 * The BIAN control record for this service domain: "Advisory Session Operating Session".
 *
 ...
 * to its asset type (Advisory Session). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Advisory Session Operating Session";
